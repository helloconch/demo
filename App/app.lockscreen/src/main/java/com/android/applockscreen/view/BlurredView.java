package com.android.applockscreen.view;
...
public class BlurredView extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        mOriginalImg = findViewById(R.id.blurredview_origin_img);
    ...
    public void setBlurredLevel(int level) {
        ...
        int alpha = (int) (ALPHA_MAX_VALUE - level * 2.55);
        Log.e("adfadfa", "alpha>>>" + alpha);
        //设置透明度
        mOriginalImg.setAlpha(alpha);
    }
