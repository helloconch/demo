package com.conch.appchart.manager;
...
import com.conch.appchart.utils.DateUtil;
import com.conch.appchart.view.LineChartMarkView;
...
//        description.setText("需要展示的内容");
    ...
    public void addLine(List<CompositeIndexBean> dataList, String name, int color) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            float y = Float.parseFloat(data.getRate());
