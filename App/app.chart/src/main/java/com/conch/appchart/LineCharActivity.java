...
import com.conch.appchart.manager.LineChartManager;
import com.conch.appchart.model.CompositeIndexBean;
import com.conch.appchart.model.IncomeBean;
import com.conch.appchart.model.LineChartBean;
import com.conch.appchart.utils.LocalJsonAnalyzeUtil;
import com.github.mikephil.charting.charts.LineChart;

import java.util.List;

@Route(path = RouteUtils.CHART_LINE_MAIN)
public class LineCharActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        //展示图表
        lineChartManager1.showLineChart(incomeBeanList,
                "我的收益", getResources().getColor(R.color.blue));
        lineChartManager1.addLine(shanghai, "上证指数",
