 ...
 * Manage UI
 */
public class AppVideoPlayerSimple extends AppVideoPlayer {

    public AppVideoPlayerSimple(Context context) {
        super(context);
    }

    public AppVideoPlayerSimple(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
