...
public class AppVideoPlayerStandard extends AppVideoPlayer {
    ...
    public AppVideoPlayerStandard(Context context) {
        super(context);
    }

    public AppVideoPlayerStandard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(AppUserActionStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
        ...
        if (i == R.id.thumb) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                if (!url.startsWith("file") && !url.startsWith("/") &&
                        !AppPlayerUtils.isWifiConnected(getContext()) && !WIFI_TIP_DIALOG_SHOWED) {
                    showWifiDialog();
                    return;
                }
                startVideo();
    ...
    public void startVideo() {
        prepareMediaPlayer();
        onEvent(AppUserActionStandard.ON_CLICK_START_THUMB);
    }
